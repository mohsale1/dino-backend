...
class TableBase(BaseModel):
    ...
    area_id: int = Field(..., description="Area ID this table belongs to")
    workspace_id: int = Field(..., description="Workspace ID this table belongs to")
