...
class PermissionRepository(BaseRepository):
    ...
    def permission_exists(self, name: str, exclude_id: Optional[str] = None) -> bool:
        ...
        # If exclude_id is provided, check if the found doc is different
        if exclude_id:
            for doc in docs:
    ...
    def get_paginated_with_filters(
        ...
        # Get all matching documents for count and search filtering
        all_docs = query.get()
    ...
    def bulk_create(self, permissions: List[Dict[str, Any]]) -> List[str]:
        ...
        for perm_data in permissions:
            ...
            perm_data['updated_at'] = datetime.utcnow()
